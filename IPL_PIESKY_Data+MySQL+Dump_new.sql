...
(2,'Feroz Shah Kotla','Delhi',48000,'Feroz Shah Kotla, Delhi',7471757880),(3,'Eden Gardens','Kolkata',90000,'Eden Gardens, Kolkata',6847069662),
(4,'Rajiv Gandhi International Stadium','Hyderabad',55000,'Rajiv Gandhi International Stadium, Hyderabad',6555859360),
(5,'MS Chidambaram Stadium','Chennai',50000,'MS Chidambaram Stadium, Chennai',9534880787),
(6,'Sawai Mansingh Stadium','Jaipur',30000,'Sawai Mansingh Stadium, Jaipur',9255986370),
(7,'M. Chinnaswamy Stadium','Bengaluru',40000,'M. Chinnaswamy Stadium, Bengaluru',6680348191),
(8,'Is Bindra Stadium','Mohali',30000,'Is Bindra Stadium, Mohali',6370992699),
(9,'Holkar Stadium','Indore',30000,'Holkar Stadium, Indore',9045919945),(10,'MCA Stadium','Pune',35000,'MCA Stadium, Pune',8541151117);
...
INSERT INTO IPL_TEAM VALUES (1,'Chennai Super Kings','Chennai, Tamil Nadu','CSK'),(2,'Delhi Daredevils','Delhi, NCR','DD'),
(3,'Kings XI Punjab','Mohali (Chandigarh CR), Punjab','KXIP'),(4,'Kolkata Knight Riders','Kolkata, West Bengal','KKR'),
(5,'Mumbai Indians','Mumbai, Maharashtra','MI'),(6,'Rajasthan Royals','Jaipur, Rajasthan','RR'),(7,'Royal Challengers Bangalore','Bangalore, Karnataka','RCB'),
(8,'Sunrisers Hyderabad','Hyderabad, Telangana','SRH');
...
INSERT INTO IPL_TEAM_PLAYERS VALUES (1,2,'Bowler','TEAM - RR'),(1,9,'All-Rounder','TEAM - MI'),
(1,19,'Batsman','TEAM - KXIP'),(1,26,'Bowler','TEAM - MI'),(1,27,'All-Rounder','TEAM - MI'),(1,28,'Batsman','TEAM - SRH'),
(1,34,'Bowler','TEAM - RCB'),(1,36,'Bowler','TEAM - DD'),(1,57,'Bowler','TEAM - SRH'),(1,59,'Batsman','TEAM - SRH'),(1,87,'Bowler','TEAM - CSK'),
(1,88,'Batsman','TEAM - DD'),(1,102,'Batsman','TEAM - KXIP'),(1,109,'Bowler','TEAM - SRH'),(1,113,'Batsman','TEAM - MI'),(1,120,'Bowler','TEAM - CSK'),
(1,136,'All-Rounder','TEAM - CSK'),(1,137,'Bowler','TEAM - CSK'),(1,145,'Batsman','TEAM - KXIP'),(1,146,'All-Rounder','TEAM - KXIP'),(2,3,'Batsman','TEAM - KXIP'),
(2,25,'Batsman','TEAM - KXIP'),(2,42,'Batsman','TEAM - RCB'),(2,52,'All-Rounder','TEAM - DD'),(2,58,'Bowler','TEAM - SRH'),(2,60,'Batsman','TEAM - DD'),
(2,66,'Bowler','TEAM - DD'),(2,72,'All-Rounder','TEAM - RCB'),(2,74,'Bowler','TEAM - CSK'),(2,90,'Bowler','TEAM - MI'),(2,94,'Batsman','TEAM - RCB'),
(2,95,'Batsman','TEAM - DD'),(2,100,'All-Rounder','TEAM - KXIP'),(2,103,'Batsman','TEAM - MI'),(2,104,'Bowler','TEAM - RCB'),(2,107,'All-Rounder','TEAM - SRH'),
(2,110,'Bowler','TEAM - RCB'),(2,111,'Bowler','TEAM - CSK'),(2,118,'All-Rounder','TEAM - MI'),(2,121,'All-Rounder','TEAM - DD'),(2,138,'All-Rounder','TEAM - CSK'),
(2,148,'Batsman','TEAM - MI'),(3,4,'Batsman','TEAM - SRH'),(3,17,'All-Rounder','TEAM - CSK'),(3,31,'Wicket Keeper','TEAM - RR'),(3,41,'Bowler','TEAM - SRH'),
(3,48,'All-Rounder','TEAM - KKR'),(3,54,'All-Rounder','TEAM - KKR'),(3,76,'Batsman','TEAM - KXIP'),(3,78,'All-Rounder','TEAM - SRH'),(3,89,'All-Rounder','TEAM - DD'),
(3,97,'Batsman','TEAM - CSK'),(3,101,'Batsman','TEAM - KXIP'),(3,106,'Wicket Keeper','TEAM - SRH'),(3,124,'All-Rounder','TEAM - RR'),(3,125,'Bowler','TEAM - RR'),
(3,132,'All-Rounder','TEAM - RR'),(3,141,'Bowler','TEAM - DD'),(4,1,'All-Rounder','TEAM - RR'),(4,5,'Batsman','TEAM - KKR'),(4,15,'Bowler','TEAM - KXIP'),
(4,21,'Wicket Keeper','TEAM - MI'),(4,29,'Bowler','TEAM - CSK'),(4,35,'All-Rounder','TEAM - CSK'),(4,40,'Batsman','TEAM - MI'),(4,47,'All-Rounder','TEAM - DD'),
(4,53,'Bowler','TEAM - KKR'),(4,64,'Wicket Keeper','TEAM - CSK'),(4,67,'Bowler','TEAM - KXIP'),(4,77,'Batsman','TEAM - KXIP'),(4,92,'Wicket Keeper','TEAM - DD'),
(4,105,'All-Rounder','TEAM - RCB'),(4,119,'All-Rounder','TEAM - CSK'),(4,127,'Bowler','TEAM - CSK'),(4,129,'Batsman','TEAM - KKR'),(5,8,'Bowler','TEAM - SRH'),
(5,10,'Wicket Keeper','TEAM - RR'),(5,12,'Bowler','TEAM - KXIP'),(5,24,'Bowler','TEAM - KKR'),(5,33,'Bowler','TEAM - KKR'),(5,43,'All-Rounder','TEAM - SRH'),
(5,46,'Bowler','TEAM - DD'),(5,50,'All-Rounder','TEAM - RCB'),(5,56,'Bowler','TEAM - RCB'),(5,68,'Bowler','TEAM - MI'),(5,69,'All-Rounder','TEAM - MI'),
(5,98,'Bowler','TEAM - CSK'),(5,128,'Bowler','TEAM - SRH'),(5,140,'Batsman','TEAM - DD'),(5,142,'All-Rounder','TEAM - DD'),(6,13,'Wicket Keeper','TEAM - KKR'),
(6,23,'Bowler','TEAM - RCB'),(6,32,'Bowler','TEAM - DD'),(6,37,'Bowler','TEAM - KXIP'),(6,44,'All-Rounder','TEAM - KKR'),(6,45,'Batsman','TEAM - RR'),
(6,51,'Bowler','TEAM - DD'),(6,55,'Batsman','TEAM - KXIP'),(6,75,'Bowler','TEAM - KKR'),(6,82,'All-Rounder','TEAM - SRH'),(6,84,'Wicket Keeper','TEAM - RCB'),
(6,85,'All-Rounder','TEAM - RCB'),(6,93,'Bowler','TEAM - KXIP'),(6,112,'Batsman','TEAM - KKR'),(6,131,'Bowler','TEAM - RR'),(6,135,'All-Rounder','TEAM - CSK'),
(6,143,'Batsman','TEAM - KKR'),(6,144,'Batsman','TEAM - KKR'),(6,147,'All-Rounder','TEAM - KXIP'),(7,16,'All-Rounder','TEAM - RR'),(7,18,'Wicket Keeper','TEAM - KKR'),
(7,20,'All-Rounder','TEAM - KXIP'),(7,30,'Wicket Keeper','TEAM - SRH'),(7,49,'Batsman','TEAM - MI'),(7,62,'Bowler','TEAM - RCB'),(7,63,'Bowler','TEAM - KXIP'),
(7,70,'Bowler','TEAM - RCB'),(7,71,'Bowler','TEAM - RCB'),(7,73,'Batsman','TEAM - CSK'),(7,80,'All-Rounder','TEAM - DD'),(7,81,'Bowler','TEAM - MI'),
(7,83,'Batsman','TEAM - KKR'),(7,91,'Bowler','TEAM - MI'),(7,115,'Bowler','TEAM - RR'),(7,116,'Bowler','TEAM - DD'),(7,122,'Bowler','TEAM - MI'),
(7,123,'Bowler','TEAM - RR'),(7,130,'Bowler','TEAM - RCB'),(7,133,'Wicket Keeper','TEAM - CSK'),(8,6,'Bowler','TEAM - KKR'),(8,7,'Batsman','TEAM - DD'),
(8,11,'Batsman','TEAM - CSK'),(8,14,'All-Rounder','TEAM - RCB'),(8,22,'Bowler','TEAM - RR'),(8,38,'All-Rounder','TEAM - RR'),(8,39,'Batsman','TEAM - RR'),
(8,61,'Wicket Keeper','TEAM - RCB'),(8,65,'Bowler','TEAM - CSK'),(8,79,'All-Rounder','TEAM - SRH'),(8,86,'Batsman','TEAM - CSK'),(8,96,'Batsman','TEAM - RCB'),
(8,99,'Bowler','TEAM - KKR'),(8,108,'Bowler','TEAM - SRH'),(8,114,'All-Rounder','TEAM - DD'),(8,117,'All-Rounder','TEAM - DD'),(8,126,'Bowler','TEAM - SRH'),
(8,134,'All-Rounder','TEAM - CSK'),(8,139,'Bowler','TEAM - DD'),(8,149,'Wicket Keeper','TEAM - MI');
...
INSERT INTO IPL_TEAM_STANDINGS VALUES (1,2017,14,9,5,0,0,18,NULL),(1,2018,14,9,5,0,0,18,'Champions'),
(2,2017,14,6,8,0,0,12,NULL),(2,2018,14,5,9,0,0,10,NULL),(3,2017,14,7,7,0,0,14,NULL),(3,2018,14,6,8,0,0,12,NULL),
(4,2017,14,8,6,0,0,16,NULL),(4,2018,14,8,6,0,0,16,NULL),(5,2017,14,10,4,0,0,20,'Champions'),(5,2018,14,6,8,0,0,12,NULL),
(6,2017,14,9,5,0,0,8,NULL),(6,2018,14,7,7,0,0,14,NULL),(7,2017,14,3,10,0,1,7,NULL),(7,2018,14,6,8,0,0,12,NULL),(8,2017,14,8,5,0,1,17,NULL),(8,2018,14,9,5,0,0,18,NULL);
...
INSERT INTO IPL_TOURNAMENT VALUES (2008,'IPL SEASON - 2008','2008-04-18 00:00:00','2008-06-01 00:00:00',8,59,'Champions - RR'),
(2009,'IPL SEASON - 2009','2009-04-18 00:00:00','2009-05-24 00:00:00',8,59,'Champions - DC'),
(2010,'IPL SEASON - 2010','2010-03-12 00:00:00','2010-04-25 00:00:00',8,60,'Champions - CSK'),
(2011,'IPL SEASON - 2011','2011-04-08 00:00:00','2011-05-28 00:00:00',10,74,'Champions - CSK'),
(2012,'IPL SEASON - 2012','2012-04-04 00:00:00','2012-05-27 00:00:00',9,76,'Champions - KKR'),
(2013,'IPL SEASON - 2013','2013-04-03 00:00:00','2013-05-26 00:00:00',9,76,'Champions - MI'),
(2014,'IPL SEASON - 2014','2014-04-16 00:00:00','2014-06-01 00:00:00',8,60,'Champions - KKR'),
(2015,'IPL SEASON - 2015','2015-04-08 00:00:00','2015-05-24 00:00:00',8,60,'Champions - MI'),
(2016,'IPL SEASON - 2016','2016-04-09 00:00:00','2016-05-29 00:00:00',8,60,'Champions - SRH'),
(2017,'IPL SEASON - 2017','2017-04-05 00:00:00','2017-05-21 00:00:00',8,60,'Champions - MI'),
(2018,'IPL SEASON - 2018','2018-04-07 00:00:00','2018-05-27 00:00:00',8,60,'Champions - CSK');
...
INSERT INTO IPL_USER VALUES ('admin','Qiheq667','Admin','System administrator'),
('USR002','Uuauj599','Bidder',NULL),('USR003','Eouaj349','Bidder',NULL),
('USR004','Xegah916','Bidder',NULL),('USR005','Fabai193','Bidder',NULL),
('USR006','Debih891','Bidder',NULL),('USR007','Toias988','Bidder',NULL),
('USR008','Oijiy996','Bidder',NULL),('USR009','Wixeb478','Bidder',NULL),('USR010','Dojoh725','Bidder',NULL),('USR011','Caxuc180','Bidder',NULL),
('USR012','Zuvut888','Bidder',NULL),('USR013','Waiay336','Bidder',NULL),('USR014','Eunud150','Bidder',NULL),('USR015','Fodiy520','Bidder',NULL),
('USR016','Taaon354','Bidder',NULL),('USR017','Qegat246','Bidder',NULL),('USR018','Latan774','Bidder',NULL),('USR019','Kenax859','Bidder',NULL),
('USR020','Oehov784','Bidder',NULL),('USR021','Jidao220','Bidder',NULL),('USR022','Mesey643','Bidder',NULL),('USR023','Jotup765','Bidder',NULL),
('USR024','Diooo769','Bidder',NULL),('USR025','Diyal596','Bidder',NULL),('USR026','Eotir416','Bidder',NULL),('USR027','Tojec918','Bidder',NULL),
('USR028','Coiep158','Bidder',NULL),('USR029','Gazou951','Bidder',NULL),
('USR030','Yuiip331','Bidder',NULL),('USR031','Kuoom311','Bidder',NULL);
...
select  ibd1.bidder_id,(count(ibd1.bid_status) * 100/ (select count(*) from ipl_bidding_details ibd2 where ibd2.bidder_id=ibd1.bidder_id
 group by ibd2.bidder_id))
 as percentage,
ibd1.bid_status from ipl_bidding_details ibd1 where ibd1.bid_status = 'Won'
group by ibd1.bidder_id order by percentage desc;

/* 2.	Which teams have got the highest and the lowest no. of bids? */

select ibd.bid_team, ibp.no_of_bids
from ipl_bidder_points ibp inner join ipl_bidding_details ibd on ibp.bidder_id = ibd.bidder_id
inner join ipl_team_standings its on its.tournmt_id=ibp.tournmt_id
group by ibd.bid_team 
having ibp.no_of_bids = max(ibp.no_of_bids) or ibp.no_of_bids = min(ibp.no_of_bids);

/* 3.	In a given stadium, what is the percentage of wins by a team which had won the toss? */


select ist.stadium_name,(count(ist.stadium_id) * 100 / (select count(ist.stadium_id)
from ipl_match im inner join ipl_match_schedule ims on im.match_id=ims.match_id
inner join ipl_stadium ist on ist.stadium_id=ims.stadium_id where ist.stadium_id=1)) as winning_percentage
from ipl_match im inner join ipl_match_schedule ims on im.match_id=ims.match_id
inner join ipl_stadium ist on ist.stadium_id=ims.stadium_id where im.toss_winner=im.match_winner and ist.stadium_id=1;

/* 4.	What is the total no. of bids placed on the team that has won highest no. of matches? */


select its.team_id,it.team_name,its.matches_won,its.matches_played,its.tournmt_id, ibp.no_of_bids, ibd.bid_team
from ipl_bidder_points ibp inner join ipl_bidding_details ibd on ibp.bidder_id= ibd.bidder_id
inner join ipl_team_standings its on its.tournmt_id=ibp.tournmt_id
inner join ipl_team it on it.team_id=its.team_id
where its.tournmt_id = 2018 and its.team_id=ibd.bid_team group by its.team_id limit 1;

/* 5.	From the current team standings, if a bidder places a bid on which of the teams, 
there is a possibility of (s)he winning the highest no. of points – in simple words, identify the team which has the highest 
jump in its total points (in terms of percentage) from the previous year to current year. */


select i.tournmt_id,i.team_id,i.matches_played,i.matches_won, i.matches_won * 100 / i.matches_played as win_percentage_2017,it.team_name,
o.tournmt_id,o.team_id,o.matches_played,o.matches_won, o.matches_won * 100 / o.matches_played as win_percentage_2018,
(o.matches_won * 100 / o.matches_played) - (i.matches_won * 100 / i.matches_played ) as 'Team with highest jump in win percentage'
from ipl_team_standings i inner join ipl_team_standings o on i.team_id=o.team_id
inner join ipl_team it on i.team_id=it.team_id
where i.tournmt_id = 2017 and o.tournmt_id = 2018 ;
